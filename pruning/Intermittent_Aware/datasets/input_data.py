...
def which_set(filename, validation_percentage, testing_percentage):
  ...
  # go into the train, test, or validation sets, and we want to keep
...
class AudioProcessor(object):
  ...
  def prepare_data_index(self, silence_percentage, unknown_percentage,
    ...
    self.data_index = {'validation': [], 'test': [], 'train': []}
    unknown_index = {'validation': [], 'test': [], 'train': []}
    all_words = {}
    ...
    silence_wav_path = self.data_index['train'][0]['file']
    for set_index in ['validation', 'test', 'train']:
  ...
  def set_size(self, mode):
    ...
    Args:
      mode: Which partition, must be 'train', 'validation', or 'test'.
  ...
  def get_data(self, how_many, offset, model_settings, background_frequency,
    ...
    Args:
      ...
      mode: Which partition to use, must be 'train', 'validation', or
        'test'.
    ...
    desired_samples = model_settings['desired_samples']
    use_background = self.background_data and (mode == 'train')
    pick_deterministically = (mode != 'train')
    # Use the processing graph we created earlier to repeatedly to generate the
    # final output sample data we'll use in train.
