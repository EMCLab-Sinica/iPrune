...
COMMON_FLAGS='--arch '$Model' --batch-size 16 --test-batch-size 16 --lr 0.0005 --epochs 50 --lr-epochs 10 --visible-gpus '$VISIBLE_GPUS' --gpus '$GPUS' --learning_rate_list '$LEARNING_RATE_LIST
